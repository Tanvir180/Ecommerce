...
<head>
    ...
    <title>Smartphone | E-Shopper</title>
					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/phn/bangkok-thailand-xiaomi-launch-new-600w-1770040889.jpg" alt="" />
										<h2>৳ 20,990</h2>
										<p>xiaomi redmi note 8 smartphone</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/phn/taipei-taiwan-march-7-2019-600w-1333307633.jpg" alt="" />
										<h2>৳ 89,990</h2>
										<p>Samsung galaxy s10 smartphone<p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
