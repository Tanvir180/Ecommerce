...
<head>
    ...
    <title>Shalwar_kameez | E-Shopper</title>
					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kameez/karachi-pakistan-december-15-2020-600w-1878718141.jpg" alt="" />
										<h2>৳ 1500</h2>
										<p>Suti Print orna,kameez,butterfly shalwar</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>৳ 4500</h2>
										<p>Afsan print kameez,shalwar,shiffon orna</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kameez/karachi-pakistan-january-15-2021-600w-1905977908.jpg" alt="" />
										<h2>৳ 3000</h2>
										<p>Silk embrodery kameez,butterfly pant,sifon orna</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kameez/karachi-pakistan-march-15-2020-600w-1689210985.jpg" alt="" />
										<h2>৳ 3200</h2>
										<p>Silk kameez,butterfly shalwar,shifon orna</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kameez/beautiful-girl-indian-national-bright-600w-567647284.jpg" alt="" />
										<h2>৳ 7000</h2>
										<p>Jorget gown,shifon orna</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
