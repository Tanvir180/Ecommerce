					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kids/childrens-dress-on-isolated-white-600w-1881158686.jpg" alt="" />
										<h2>৳ 1200</h2>
										<p>Blue frog for little baby girl<p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kids/pf-f5f97d4e-aacd-43c4-a7f6-4e5aa8893d84--babyboynewarrivals.jpg" alt="" />
										<h2>৳ 1500</h2>
										<p>T-shirt,pant for baby boy</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
