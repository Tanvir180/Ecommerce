					...
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-260nw-1923192866.jpg" alt="" />
											<h2>৳ 1200</h2>
											<p>Stylish Butterfly design kurti</p>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923192884.jpg" alt="" />
										<h2>৳ 1100</h2>
										<p>New exclusive kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923192917.jpg" alt="" />
										<h2>৳ 2500</h2>
										<p>Gown styles kurti<p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923192977.jpg" alt="" />
										<h2>৳ 1200</h2>
										<p>Navyblue cotton kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923192980.jpg" alt="" />
										<h2>৳ 1500</h2>
										<p>Stylish Indian butterfly kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>৳ 1500</h2>
											<p>SStylish Indian butterfly kurti</p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923194984.jpg" alt="" />
										<h2>৳ 1500</h2>
										<p>New exclusive pakistani kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/pretty-indian-model-sky-blue-600w-633681104.jpg" alt="" />
										<h2>৳ 1000</h2>
										<p>Panjabi stylish butterfly kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/karachi-pakistan-february-10-2021beautiful-600w-1923192857.jpg" alt="" />
										<h2>৳ 1200</h2>
										<p>Afsan print butterfly kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/Kurti/beautiul-indian-female-model-red-600w-616124729.jpg" alt="" />
										<h2>৳ 900</h2>
										<p>Red silk kurti</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
